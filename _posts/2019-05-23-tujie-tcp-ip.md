...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_1_14.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_1_18.png?raw=true)

<p>
各个分层的作用。
</p>

![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_1_19.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_1_29.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_1_30.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_1_32.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_zi_1.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_2_3.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_zi_2.png?raw=true) 
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_2_8.png?raw=true) 
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_2_17.png?raw=true) 
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_2_18.png?raw=true) 
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_2_19.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_3_3.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_3_4.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_3_5.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_3_12.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_3_15.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_3_18.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_3_20.png?raw=true)

- 类型：网络层协议类型

![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_3_2.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_1.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_2.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_5.png?raw=true)

<p>
为了将数据包发送给目标主机，所有主机都维护者一张路由控制表（Routing Table），该表记录IP数据在下一步应该发给哪一个路由器。IP包将根据这个路由表在各个数据链路上传输。
</p>

![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_8.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_7.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_24.png?raw=true)

#### IPV4与IPv6

![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_31.png?raw=true)

![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_4_33.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_5_5.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_5_6.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_5_2.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_5_17.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_5_19.png?raw=true)

![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_5_20.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_5_22.png?raw=true)

<p>
IP隧道中可以将那些从网络A发过来的IPv6包统和为一个数据，再为之追加一个IPv4的首部转发给网络C，这种在网络层的首部后面继续追加网络层首部的通信方法叫做<code>IP隧道</code>。
</p>

![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_5_23.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_6_10.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_6_12.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_6_18.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_6_19.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_6_26.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_6_24.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_7_1.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_7_4.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_7_5.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_8_10.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_8_3.png?raw=true)
...
![image]({{site.url}}/img/2019-05-22-tcp-ip/tu_8_18.png?raw=true)

- HTTP1.0：每一个命令和应答都会触发一次TCP连接的建立与断开
- HTTP1.1：一个TCP连接上发送多个命令和应答

![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_8_8_1.png?raw=true)

![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_8_8_2.png?raw=true)

![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_8_8_3.png?raw=true)

![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_8_8_4.png?raw=true)

![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_8_8_5.png?raw=true)

![image]({{site.url}}/img/2019-05-22-tcp-ip/biao_8_8_6.png?raw=true)
